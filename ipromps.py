...
class ProMP(object):
    ...
    """
    def __init__(self, num_basis=31,
                       sigma_basis=0.05,
                       num_samples=101,
                       sigmay=0.0,
                       min_max_scaler=None,                       
    ...
    def param_update(self, randomness=1e-10):
        """
        :param randomness:
        :return:
        """
    ...
    def plot_uViapoints(self):
        ...
        for viapoint_id, viapoint in enumerate(self.viapoints):
            if viapoint_id == 0:
                plt.plot(viapoint['t'], viapoint['obsy'], marker="o", markersize=5, color='blue', label='via points')
            else:
                plt.plot(viapoint['t'], viapoint['obsy'], marker="o", markersize=5, color='blue')
